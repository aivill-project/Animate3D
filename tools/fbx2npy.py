...
SRC_DATA_DIR =r'C:\Users\bk221\OneDrive\C Documents\GitHub\Animate3D\mixamo_data\pius'
...
def fbx2jointDict():
    ...
    anims_path = glob(SRC_DATA_DIR + '/*.fbx')
    ...
    for anim_name in anims_path:
        ...
        for i in range(int(frame_end)+1):
            ...
            out_dict = {'pose_keypoints_3d': [], 'pose_keypoints_2d': []}
